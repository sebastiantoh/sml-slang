...
export declare class SmlParser extends Parser {
    ...
    static readonly PLUS = 39;
    static readonly MINUS = 40;
    static readonly CARET = 41;
    static readonly CONS = 42;
    static readonly AT = 43;
    static readonly EQ = 44;
    static readonly NEQ = 45;
    static readonly LT = 46;
    static readonly GT = 47;
    static readonly LTE = 48;
    static readonly GTE = 49;
    static readonly ANDALSO = 50;
    static readonly ORELSE = 51;
    static readonly QUOTE = 52;
