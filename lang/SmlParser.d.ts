...
export declare class InfixApplicationContext extends ExpContext {
    ...
    STARDOT(): TerminalNode | undefined;
    PLUS(): TerminalNode | undefined;
    PLUSDOT(): TerminalNode | undefined;
    MINUS(): TerminalNode | undefined;
    MINUSDOT(): TerminalNode | undefined;
...
export declare class ExpTypeAnnotationContext extends ExpContext {
    exp(): ExpContext;
    COLON(): TerminalNode;
    typ(): TypContext;
    constructor(ctx: ExpContext);
