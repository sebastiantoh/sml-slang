...
import { PatListContext } from "./SmlParser";
...
export interface SmlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the `PatInfixConstruction`
	 * labeled alternative in `SmlParser.pat`.
	 * @param ctx the parse tree
	 */
	enterPatInfixConstruction?: (ctx: PatInfixConstructionContext) => void;
	/**
	 * Exit a parse tree produced by the `PatInfixConstruction`
	 * labeled alternative in `SmlParser.pat`.
	 * @param ctx the parse tree
	 */
	exitPatInfixConstruction?: (ctx: PatInfixConstructionContext) => void;

	/**
	 * Enter a parse tree produced by the `PatParentheses`
	 * labeled alternative in `SmlParser.pat`.
	 * @param ctx the parse tree
	 */
	enterPatParentheses?: (ctx: PatParenthesesContext) => void;
	/**
	 * Exit a parse tree produced by the `PatParentheses`
	 * labeled alternative in `SmlParser.pat`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the `PatList`
	 * labeled alternative in `SmlParser.pat`.
	 * @param ctx the parse tree
	 */
	enterPatList?: (ctx: PatListContext) => void;
	/**
	 * Exit a parse tree produced by the `PatList`
	 * labeled alternative in `SmlParser.pat`.
	 * @param ctx the parse tree
	 */
	exitPatList?: (ctx: PatListContext) => void;
	...
	/**
	 * Enter a parse tree produced by the `CaseAnalysis`
	 * labeled alternative in `SmlParser.exp`.
	 * @param ctx the parse tree
	 */
	enterCaseAnalysis?: (ctx: CaseAnalysisContext) => void;
	/**
	 * Exit a parse tree produced by the `CaseAnalysis`
	 * labeled alternative in `SmlParser.exp`.
	 * @param ctx the parse tree
	 */
	exitCaseAnalysis?: (ctx: CaseAnalysisContext) => void;
