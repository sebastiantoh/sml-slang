...
export interface SmlVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by the `PatInfixConstruction`
	 * labeled alternative in `SmlParser.pat`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitPatInfixConstruction?: (ctx: PatInfixConstructionContext) => Result;
	...
	/**
	 * Visit a parse tree produced by the `PatList`
	 * labeled alternative in `SmlParser.pat`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitPatList?: (ctx: PatListContext) => Result;

	/**
	 * Visit a parse tree produced by the `PatTypeAnnotation`
	 * labeled alternative in `SmlParser.pat`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitPatTypeAnnotation?: (ctx: PatTypeAnnotationContext) => Result;
	...
	/**
	 * Visit a parse tree produced by the `ExpTypeAnnotation`
	 * labeled alternative in `SmlParser.exp`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitExpTypeAnnotation?: (ctx: ExpTypeAnnotationContext) => Result;
